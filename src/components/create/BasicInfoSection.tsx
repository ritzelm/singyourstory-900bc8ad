              ...
              >
                {["0-2", "3-5", "6-8", "9-10", "10-99"].map((age) => (
                  <div key={age} className="relative">
                    ...
                    <label
                      htmlFor={`age-${age}`}
                      className="flex items-center justify-center px-4 py-2 rounded-md cursor-pointer text-[#333333] border-2 border-transparent bg-[#FFF0F9] hover:bg-[#E535AB] hover:text-white peer-checked:bg-[#E535AB] peer-checked:text-white peer-checked:border-[#E535AB] peer-checked:shadow-lg peer-checked:scale-105 transition-all duration-200 ease-in-out transform"
                    >
                      {age}
                    </label>
                  </div>
