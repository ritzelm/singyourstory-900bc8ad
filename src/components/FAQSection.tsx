      ...
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <Accordion type="single" collapsible className="mb-12">
          <AccordionItem value="item-1" className="text-left">
            <AccordionTrigger className="text-left">Wie personalisiere ich ein Lied?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2" className="text-left">
            <AccordionTrigger className="text-left">Wie lange dauert es, bis ich meinen Song erhalte?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3" className="text-left">
            <AccordionTrigger className="text-left">Welche Formate sind verfügbar?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-4" className="text-left">
            <AccordionTrigger className="text-left">Kann ich mehrere Kinder in einem Lied erwähnen?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-5" className="text-left">
            <AccordionTrigger className="text-left">Kann ich den Song verschenken?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-6" className="text-left">
            <AccordionTrigger className="text-left">Für welche Anlässe eignen sich die Lieder?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-7" className="text-left">
            <AccordionTrigger className="text-left">Kann ich den Song vor der Bestellung anhören?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-8" className="text-left">
            <AccordionTrigger className="text-left">Was passiert, wenn ich mit dem Song nicht zufrieden bin?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-9" className="text-left">
            <AccordionTrigger className="text-left">Welche Zahlungsmethoden werden akzeptiert?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-10" className="text-left">
            <AccordionTrigger className="text-left">Kann ich den Song nachträglich ändern lassen?</AccordionTrigger>
            <AccordionContent>
